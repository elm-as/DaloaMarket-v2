...
const STEPS = [
  {
    ...
    description: "Inscrivez-vous gratuitement en quelques secondes avec votre e-mail ou votre compte Google. Complétez votre profil et créez votre boutique.",
    color: 'text-blue-500',
    bg: 'bg-blue-100',
  },
  {
    ...
    description: 'Publiez gratuitement, sans limite d\'annonces. Le Pass Vendeur Pro (2 500 FCFA/mois) ajoute le badge vérifié et des avantages de vente.',
